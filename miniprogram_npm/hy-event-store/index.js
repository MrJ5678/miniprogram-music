...
__DEFINE__(1644306482543, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1644306482544,"./event-store":1644306482545}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644306482544, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1644306482545, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1644306482544,"./utils":1644306482546}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644306482546, function(require, module, exports) {
...
return __REQUIRE__(1644306482543);
})()
